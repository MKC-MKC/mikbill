...
Так как официальная документация и сам MikBiLL API не использует систему версионирования,
...
Некоторые поля и методы не описаны, т.к. официальной документации на каждый параметр попросту нет.
